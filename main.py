...
parser.add_argument('--val-data', type=str, default='D:\git\crawler\zigbang\\val')
parser.add_argument('--batch-size',type=int ,default=2)
parser.add_argument('--lr', type=float, default=1e-4)
parser.add_argument('--max-iter',type=int, default=1000000)
parser.add_argument('--input-size', type=int,nargs='+', default=[512,512])
parser.add_argument('--checkpoint',type=str, default='checkpoints/pconv')
parser.add_argument('--iter-log', type=int, default=1000)
parser.add_argument('--iter-save',type=int, default=1000)
parser.add_argument('--iter-sample',type=int, default=1000)
parser.add_argument('--iter-eval', type=int, default=1000)
